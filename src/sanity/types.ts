...
// Query: *[_type == 'startup' && defined(slug.current) && !defined($search) || title match ($search) || category match ($search) || author->name match ($search) ] | order(_createdAt desc) {  _id    ,title    ,_createdAt    ,author ->{ _id                , name                , image                ,bio}    ,image    ,category    ,slug    ,views    ,description}
...
// Query: *[_type == 'startup' &&  _id == $id][0] {  _id    ,title    ,_createdAt    ,author ->{ _id                , name                , image                ,username                ,bio}    ,image    ,category    ,slug    ,views    ,description    ,pitch}
...
// Query: *[_type == "startup" && author._ref == $id] | order(_createdAt desc) {    _id,    title,    _createdAt,    author->{      _id,      name,      image,      bio    },    image,    category,    slug,    views,    description  }
